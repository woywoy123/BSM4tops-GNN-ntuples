	...
	class EventSaver : public top::EventSaverFlatNtuple
  	{
			...
			// Decay Chain particles
			_ivec m_DCTopIndex; 
			_ivec m_DCDecayIndex; 	
			_fvec m_DC_pt; 
			_fvec m_DC_eta; 
			_fvec m_DC_phi;
			_fvec m_DC_e;  
			...
			_fvec m_DC_pdgid; 
				...
				m_DC_pdgid.clear(); 
      			...
      			void FillBranches()
      			{
					...
					// Decay Chain Particles
					systematicTree -> makeOutputVariable(m_DCTopIndex, "DecayTopIndex"); 
					systematicTree -> makeOutputVariable(m_DCDecayIndex, "DecayIndex");
					systematicTree -> makeOutputVariable(m_DC_pt, "Decay_pt"); 
					systematicTree -> makeOutputVariable(m_DC_eta, "Decay_eta"); 
					systematicTree -> makeOutputVariable(m_DC_phi, "Decay_phi"); 
					systematicTree -> makeOutputVariable(m_DC_e, "Decay_e"); 
					systematicTree -> makeOutputVariable(m_DC_charge, "Decay_charge"); 
					systematicTree -> makeOutputVariable(m_DC_pdgid, "Decay_pdgid"); 
        			}
      			}
  	}; 
}
